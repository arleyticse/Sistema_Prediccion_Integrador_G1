...
public class CalculoObtimizacionControlador {
    ...
    public ResponseEntity<CalculoObtimizacionResponse> calcularObtimizacion(
        ...
        CalculoObtimizacionResponse respuesta = calculoServicio.calcularObtimizacion(productoId, request);
    ...
    public ResponseEntity<CalculoObtimizacionResponse> obtenerCalculo(
            @Parameter(description = "ID del cálculo")
            @PathVariable Integer calculoId) {
        
        log.info("GET /api/calculo-optimizacion/{}", calculoId);
        
        CalculoObtimizacionResponse respuesta = calculoServicio.obtenerCalculoPorId(calculoId);
    ...
    public ResponseEntity<CalculoObtimizacionResponse> obtenerUltimoCalculo(
            @Parameter(description = "ID del producto")
            @PathVariable Integer productoId) {
        
        log.info("GET /api/calculo-optimizacion/producto/{}/ultimo", productoId);
        
        CalculoObtimizacionResponse respuesta = calculoServicio.obtenerUltimoCalculoPorProducto(productoId);
        return ResponseEntity.ok(respuesta);
    }
    ...
    public ResponseEntity<Page<CalculoObtimizacionResponse>> listarCalculosPorProducto(
            @Parameter(description = "ID del producto")
            @PathVariable Integer productoId,
        ...
        Page<CalculoObtimizacionResponse> respuesta = calculoServicio.listarCalculosPorProducto(productoId, pageable);
        return ResponseEntity.ok(respuesta);
    }
    ...
    public ResponseEntity<Page<CalculoObtimizacionResponse>> listarTodos(
            @ParameterObject Pageable pageable) {
        
        log.info("GET /api/calculo-optimizacion");
        
        Page<CalculoObtimizacionResponse> respuesta = calculoServicio.listarTodosLosCalculos(pageable);
        return ResponseEntity.ok(respuesta);
    }
    ...
    public ResponseEntity<CalculoObtimizacionResponse> actualizarCalculo(
            @Parameter(description = "ID del cálculo")
            @PathVariable Integer calculoId,
            @Valid @RequestBody CalculoObtimizacionCreateRequest request) {
        ...
        CalculoObtimizacionResponse respuesta = calculoServicio.actualizarCalculo(calculoId, request);
        return ResponseEntity.ok(respuesta);
    }
