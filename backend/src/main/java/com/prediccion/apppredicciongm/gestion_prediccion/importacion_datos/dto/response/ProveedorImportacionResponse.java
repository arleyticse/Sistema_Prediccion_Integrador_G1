...
/**
 * DTO de respuesta para operaciones de importación de proveedores.
 * <p>
...
@NoArgsConstructor
@AllArgsConstructor
public class ProveedorImportacionResponse {
     ...
     * <p>Cada error incluye número de fila, razón social y descripción del error.</p>
     */
    @Builder.Default
    ...
    public static class DetalleErrorImportacion {
        ...
        /**
         * Razón social del proveedor que causó el error.
         */
     ...
     * @param razonSocial  razón social del proveedor con error
     * @param error        descripción del error
     */
    public void agregarError(Integer fila, String razonSocial, String error) {
    ...
    public String generarResumen() {
        ...
        resumen.append("=== Importación de Proveedores Completada ===\n");
        ...
        if (registrosFallidos > 0 && erroresDetallados != null && !erroresDetallados.isEmpty()) {
            ...
            erroresDetallados.stream()
                ...
                .forEach(error -> resumen.append(String.format(
                    "  Fila %d (%s): %s\n", 
                    error.getNumeroFila(), 
                    error.getRazonSocial() != null ? error.getRazonSocial() : "N/A",
