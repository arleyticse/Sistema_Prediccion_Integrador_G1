 ...
 * 
 * Proporciona funcionalidades avanzadas de predicción usando múltiples
 * algoritmos de ML,
 * selección automática del mejor modelo, detección de estacionalidad y
 * generación
...
public interface ISmartPredictorService {
     ...
     * 3. Selecciona automáticamente el mejor modelo basado en métricas de
     * validación
     ...
     * @throws IllegalArgumentException Si el producto no existe o no tiene datos
     *                                  históricos suficientes
     * @throws RuntimeException         Si ocurre un error durante el entrenamiento
     *                                  de los modelos
     */
    SmartPrediccionResponse generarPrediccionInteligente(SmartPrediccionRequest request);

    /**
     * Obtiene predicciones inteligentes para todos los productos con alertas de
     * inventario.
     * 
     * Este método procesa automáticamente todos los productos que tienen alertas
     * activas de inventario y genera predicciones para ayudar en la toma de
     * decisiones.
     * 
    ...
    /**
     * Valida si un producto tiene suficientes datos históricos para generar una
