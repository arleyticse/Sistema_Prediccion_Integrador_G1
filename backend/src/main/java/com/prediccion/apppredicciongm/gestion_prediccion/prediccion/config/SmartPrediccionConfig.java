 ...
 * 
 * Configura los beans necesarios para el funcionamiento del sistema de predicción
...
public class SmartPrediccionConfig {
    ...
    @ConditionalOnProperty(
        name = "app.prediccion.smart.enabled", 
        havingValue = "true", 
        matchIfMissing = true
    )
    public ISmartPredictorService smartPredictorService(
        ...
        log.info("[PREDICCION] Algoritmos disponibles: {}", smartPredictorServiceImpl.obtenerAlgoritmosDisponibles().size());
